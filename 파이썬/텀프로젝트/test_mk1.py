...
def save_input_data(): 
    try:
        input_fileD=open("C:\\Users\\박소호\\Documents\\프로그래밍1\\자료\\가계부\\가계부 수입.txt",'a')
...
def save_output_data(): 
    try:
        output_fileD=open("C:\\Users\\박소호\\Documents\\프로그래밍1\\자료\\가계부\\가계부 지출.txt",'a')
...
def save_money(): 
    global total_price
    money_fileD=open("C:\\Users\\박소호\\Documents\\프로그래밍1\\자료\\가계부\\자산.txt","a")
...
def money():
    ...
    money_fileD=open("C:\\Users\\박소호\\Documents\\프로그래밍1\\자료\\가계부\\자산.txt")
